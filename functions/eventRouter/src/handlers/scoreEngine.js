// §9.10: A6. Deterministic weighted formulas — transparent and defensible in an FYP viva,
// no LLM involved.
...
module.exports = async function scoreEngine({ log, error }) {
  ...
  return { customers: customers.total, workers: workers.total };
};
