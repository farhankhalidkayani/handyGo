// analyticsRollup — §9.1/A7. Scheduled (daily). Rules-based aggregation for admin dashboards;
// LLM narrative generation is left to the Admin Panel UI calling aiChat-style prompts on top
// of this data, so this function stays cheap, deterministic and always-on.
