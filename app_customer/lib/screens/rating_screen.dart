          ...
          Column(
            children: [
              Container(
                ...
                child: Icon(Icons.celebration_outlined, size: 32, color: scheme.onPrimaryContainer),
              ),
              const SizedBox(height: 12),
              Text('How was your service?', style: Theme.of(context).textTheme.titleLarge),
            ],
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 12),
                  _InvoiceRow(label: 'Service charges', amount: _invoice!.serviceCharges),
                  if (_invoice!.materialCharges > 0)
                    _InvoiceRow(label: 'Materials', amount: _invoice!.materialCharges),
